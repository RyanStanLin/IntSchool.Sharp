...
namespace IntSchool.Sharp.Core.Models
{
    ...
    public partial class GetAttendanceResponseModel
    {
        public static GetAttendanceResponseModel FromJson(string json) => JsonConvert.DeserializeObject<GetAttendanceResponseModel>(json, ConverterGetAttendanceResponseModel.Settings);
    }

    public static class SerializeGetAttendanceResponseModel
    {
        public static string ToJson(this GetAttendanceResponseModel self) => JsonConvert.SerializeObject(self, ConverterGetAttendanceResponseModel.Settings);
    }
