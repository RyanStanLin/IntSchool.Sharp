...
namespace IntSchool.Sharp.Models
{
    ...
    public partial class GetMarkDetailResponseModel
    {
        public static GetMarkDetailResponseModel FromJson(string json) => JsonConvert.DeserializeObject<GetMarkDetailResponseModel>(json, IntSchool.Sharp.Models.ConverterGetMarkDetailResponseModel.Settings);
    }

    public static class SerializeGetMarkDetailResponseModel
    {
        public static string ToJson(this GetMarkDetailResponseModel self) => JsonConvert.SerializeObject(self, IntSchool.Sharp.Models.ConverterGetMarkDetailResponseModel.Settings);
    }
