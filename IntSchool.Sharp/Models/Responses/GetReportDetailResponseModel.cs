...
namespace IntSchool.Sharp.Models
{
    ...
    public partial class GetReportDetailResponseModel
    {
        public static GetReportDetailResponseModel FromJson(string json) => JsonConvert.DeserializeObject<GetReportDetailResponseModel>(json, IntSchool.Sharp.Models.ConverterGetReportDetailResponseModel.Settings);
    }

    public static class SerializeGetReportDetailResponseModel
    {
        public static string ToJson(this GetReportDetailResponseModel self) => JsonConvert.SerializeObject(self, IntSchool.Sharp.Models.ConverterGetReportDetailResponseModel.Settings);
    }
