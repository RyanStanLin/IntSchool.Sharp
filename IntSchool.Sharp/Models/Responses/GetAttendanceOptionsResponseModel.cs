...
namespace IntSchool.Sharp.Models
{
    ...
    public partial class GetAttendanceOptionsResponseModel
    {
        public static List<GetAttendanceOptionsResponseModel> FromJson(string json) => JsonConvert.DeserializeObject<List<GetAttendanceOptionsResponseModel>>(json, IntSchool.Sharp.Models.ConverterGetAttendanceOptionsResponseModel.Settings);
    }

    public static class SerializeGetAttendanceOptionsResponseModel
    {
        public static string ToJson(this List<GetAttendanceOptionsResponseModel> self) => JsonConvert.SerializeObject(self, IntSchool.Sharp.Models.ConverterGetAttendanceOptionsResponseModel.Settings);
    }
