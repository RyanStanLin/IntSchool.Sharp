...
namespace IntSchool.Sharp.Models
{
    ...
    public partial class GetAccountStudentsResponseModel
    {
        public static List<GetAccountStudentsResponseModel> FromJson(string json) => JsonConvert.DeserializeObject<List<GetAccountStudentsResponseModel>>(json, IntSchool.Sharp.Models.ConverterGetAccountStudentsResponseModel.Settings);
    }

    public static class SerializeGetAccountStudentsResponseModel
    {
        public static string ToJson(this List<GetAccountStudentsResponseModel> self) => JsonConvert.SerializeObject(self, IntSchool.Sharp.Models.ConverterGetAccountStudentsResponseModel.Settings);
    }
