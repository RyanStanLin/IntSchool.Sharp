...
namespace IntSchool.Sharp.Core.Models
{
    ...
    public partial class GetReportListResponseModel
    {
        public static List<GetReportListResponseModel> FromJson(string json) => JsonConvert.DeserializeObject<List<GetReportListResponseModel>>(json, ConverterGetReportListResponseModel.Settings);
    }

    public static class SerializeGetReportListResponseModel
    {
        public static string ToJson(this List<GetReportListResponseModel> self) => JsonConvert.SerializeObject(self, ConverterGetReportListResponseModel.Settings);
    }
