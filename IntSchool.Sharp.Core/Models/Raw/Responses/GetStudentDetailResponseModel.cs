...
namespace IntSchool.Sharp.Core.Models
{
    ...
    public partial class GetStudentDetailResponseModel
    {
        public static GetStudentDetailResponseModel FromJson(string json) => JsonConvert.DeserializeObject<GetStudentDetailResponseModel>(json, ConverterGetStudentDetailResponse.Settings);
    }

    public static class SerializeGetStudentDetailResponse
    {
        public static string ToJson(this GetStudentDetailResponseModel self) => JsonConvert.SerializeObject(self, ConverterGetStudentDetailResponse.Settings);
    }
