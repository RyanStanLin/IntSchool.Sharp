...
namespace IntSchool.Sharp.Core.Models
{
    ...
    public partial class LoginResponseModel
    {
        public static LoginResponseModel FromJson(string json) => JsonConvert.DeserializeObject<LoginResponseModel>(json, ConverterLoginResponseModel.Settings);
    }

    public static class SerializeLoginResponseModel
    {
        public static string ToJson(this LoginResponseModel self) => JsonConvert.SerializeObject(self, ConverterLoginResponseModel.Settings);
    }
