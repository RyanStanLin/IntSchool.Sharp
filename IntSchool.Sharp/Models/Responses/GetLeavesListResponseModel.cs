...
namespace IntSchool.Sharp.Models
{
    ...
    public partial class GetLeavesListResponseModel
    {
        public static GetLeavesListResponseModel FromJson(string json) => JsonConvert.DeserializeObject<GetLeavesListResponseModel>(json, IntSchool.Sharp.Models.ConverterGetLeavesListResponseModel.Settings);
    }

    public static class SerializeGetLeavesListResponseModel
    {
        public static string ToJson(this GetLeavesListResponseModel self) => JsonConvert.SerializeObject(self, IntSchool.Sharp.Models.ConverterGetLeavesListResponseModel.Settings);
    }
