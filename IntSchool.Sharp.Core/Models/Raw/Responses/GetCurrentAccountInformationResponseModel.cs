...
namespace IntSchool.Sharp.Core.Models
{
    ...
    public partial class GetCurrentAccountInformationResponseModel
    {
        public static GetCurrentAccountInformationResponseModel FromJson(string json) => JsonConvert.DeserializeObject<GetCurrentAccountInformationResponseModel>(json, ConverterGetCurrentAccountInformationResponseModel.Settings);
    }

    public static class SerializeGetCurrentAccountInformationResponseModel
    {
        public static string ToJson(this GetCurrentAccountInformationResponseModel self) => JsonConvert.SerializeObject(self, ConverterGetCurrentAccountInformationResponseModel.Settings);
    }
