...
public interface IIntSchoolFunctions
{
    ...
    Task<GetStudentDetailResponseModel> GetStudentDetailAsync([Description("Target student's studentId")]string studentId,
    ...
    Task<GetStudentCurriculumResponseModel> GetStudentCurriculumAsync(
        ...
        [Description("Target student's studentId")]string studentId,
